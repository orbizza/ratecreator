...
export function MetadataSidebar() {
  ...
  return (
    <div className=" border-neutral-200 dark:border-neutral-800 w-[400px] fixed right-4 top-[80px] bottom-0 z-40 shadow-lg p-6 overflow-y-auto bg-white dark:bg-neutral-900 transition-all duration-200 rounded-md">
